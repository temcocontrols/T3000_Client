    ...
    <q-card style="min-width: 450px">
      ...
      <q-card-section class="q-pt-none">
        <file-upload
          ...
          :types="['image/*']"
          :path="`project-images/${projectClone?.project?.slug}`"
  ...
  <q-header elevated class="bg-white text-black">
    <app-toolbar class="bg-primary text-white edit-page">
      ...
      <template #desktop-menu>
        ...
        >Edit Project: {{ project?.project?.name }}</h1>
      </template>
    ...
    <div class="container mx-auto px-4">
      <div v-if="!fetching">
        <template v-if="projectClone?.project">
          <div class="flex items-center justify-start pt-4">
            <div class="image-container relative">
              <figure class="project-header-image pr-4">
                <img
                  v-if="!projectClone?.project?.image?.path"
            ...
            <q-input
              class="grow py-4"
              v-model="projectClone.project.name"
              label="Name"
          ...
          <q-input
            class="py-2"
            v-model="projectClone.project.description"
            label="Description"
            type="textarea"
            autogrow
          ...
          <div class="flex flex-col md:flex-row flex-nowrap mt-2">
            ...
            <AppEditor
              ...
              type="Project"
              :slug="projectClone?.project?.slug"
