...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_encode_function_error')) {
        Object.defineProperty(Module['ready'], '_encode_function_error', { configurable: true, get: function() { abort('You are getting _encode_function_error on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_encode_function_error', { configurable: true, set: function() { abort('You are setting _encode_function_error on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = '/t3-interpretor.wasm';
...
/** @type {function(...*):?} */
var _encode_function_error = Module["_encode_function_error"] = createExportWrapper("encode_function_error");
